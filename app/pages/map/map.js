...
Page({
  data: { stores: [], route: [], routeNodes: [], parking: { areas: [], total_free: 0, total: 0 }, activeId: '', focusStore: null, showDetail: false },
  ...
  async onShow() {
    try {
      ...
      this.setData({ stores, route, routeNodes, parking: { ...parking, total }, activeId: focusStore ? focusStore.id : '', focusStore, showDetail: Boolean(focusStore) });
