...
.f3d-replay { position:absolute;right:12px;top:12px;border:1px solid rgba(255,255,255,.35);border-radius:18px;background:rgba(18,22,58,.78);color:#fff;padding:7px 13px;cursor:pointer; }
